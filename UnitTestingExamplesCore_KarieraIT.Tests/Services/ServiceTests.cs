...
namespace UnitTestingExamplesCore_KarieraIT.Tests
{
    public class ServiceTests
    {
        ...
        [TestCase(1.0, 5.0, 1.0, 1.0, TestName = "Calculate_PositiveValueAndRandomServiceWithSeed_InputValuePlusRandomValue")]
        [TestCase(0.0, 5.0, 1.0, 5.0, TestName = "Calculate_ZeroAndRandomServiceWithSeed_RandomValue")]
        [TestCase(-1.0, 5.0, 1.0, 5.0, TestName = "Calculate_NegativeValueAndRandomServiceWithSeed_RandomValue")]
